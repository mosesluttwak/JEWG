...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x107f; // addresses start with "jg"
...
const uint64_t DIFFICULTY_TARGET                             = 76; // seconds
...
const char     CRYPTONOTE_NAME[]                             = "JEWG";
const char     GENESIS_COINBASE_TX_HEX[]                     = "";
